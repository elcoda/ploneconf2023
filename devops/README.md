...
```
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2023-elcoda.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    ploneconf2023-elcoda.tangrama.com.br:
      ansible_user: root
      host: ploneconf2023-elcoda
      hostname: ploneconf2023-elcoda.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/ploneconf2023-elcoda.tangrama.com.br.yml` to the remote server with:
